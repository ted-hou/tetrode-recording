...
[bootSpontaneous.press.h(cSpontaneous.hasPress), bootSpontaneous.press.muDiffCI(cSpontaneous.hasPress, :), bootSpontaneous.press.muDiffObs(cSpontaneous.hasPress)] = bootstrapMoveResponse( ...
    ...
    responseWindow=[-0.1, 0.2], correction=correction);
fprintf(1, '\nAll done\n')
...
% end
save('C:\SERVER\Units\acute_spontaneous_reach\meta\SNr_SingleUnit_NonDuplicate_NonDrift_20250117.mat', ...
    'bootSpontaneous', 'cSpontaneous', 'etaSpontaneous', 'etaSpontaneousRaw', 'onset', 'onsetThreshold', 'traj', 'correction', 'expSpontaneous', ...
    '-v7.3')
