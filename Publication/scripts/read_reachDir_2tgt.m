...
for iExp = 1:nExp
    ...
    for iTrial = 1:nTrials
        data = [ ...
            normalize(traj2tgt(iExp).contra.x(iTrial, :), 'zscore', 'robust'); ...
            normalize(traj2tgt(iExp).contra.y(iTrial, :), 'zscore', 'robust'); ...
            normalize(traj2tgt(iExp).contra.z(iTrial, :), 'zscore', 'robust'); ...
            normalize(traj2tgt(iExp).ipsi.x(iTrial, :), 'zscore', 'robust'); ...
            normalize(traj2tgt(iExp).ipsi.y(iTrial, :), 'zscore', 'robust'); ...
            normalize(traj2tgt(iExp).ipsi.z(iTrial, :), 'zscore', 'robust'); ...
            ];
