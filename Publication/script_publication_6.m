...
text(ax, -1, yl(1)-0.75, 'Time to bar contact (s)', HorizontalAlignment='center', VerticalAlignment='top')
text(ax, 0.8+3/8, yl(1)-0.75, 'Lick phase', HorizontalAlignment='center', VerticalAlignment='top')
