...
eta.correctPress = eu.getETA('count', 'PressCorrect', [-4, 4], alignTo='stop', ...
    normalize='none', resolution=0.1, ...
    lickArtifactLength=10, lickArtifactLengthType='ms', lickArtifactDirection='both', ...
    lickOffArtifactLength=10, lickOffArtifactLengthType='ms', lickOffArtifactDirection='both');
