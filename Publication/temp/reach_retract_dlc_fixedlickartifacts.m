...
[boot.correctAnyLastLickOffNorm.h, boot.correctAnyLastLickOffNorm.ci, boot.correctAnyLastLickOffNorm.obs] = bootstrapMoveResponse(eu, ...
    struct(baseline='CorrectAnyMoveToLastLickOffNorm', response='CorrectAnyMoveToLastLickOffNorm'), nboot=boot.params.nboot, ...
    baselineWindow=boot.params.baselineWindow.press, ...
    responseWindow=boot.params.responseWindow.lastLickOff, ...
    alignTo=struct(baseline='start', response='stop'), ...
    allowedTrialDuration=struct(baseline=[2, Inf], response=[4, Inf]), ...
    alpha=boot.params.alpha, artifacts=boot.params.artifacts);  
