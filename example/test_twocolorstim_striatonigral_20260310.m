...
folders = { ...
    'C:\SERVER\desmond43\desmond43_20260312', ...
    'C:\SERVER\desmond43\desmond43_20260313', ...
    };

outputFolders = { ...
    'C:\SERVER\Units\Test\desmond43_20260312', ...
    'C:\SERVER\Units\Test\desmond43_20260313', ...
    };
...
for iSession = 1:2
    clear clc
    eu = EphysUnit.load(outputFolders{iSession}, waveforms=false, spikecounts=false, spikerates=false);
    ...
    p.stimBluePowers = [500]*1e-6; 
    p.stimRedPowers = [500]*1e-6;
    ...
    for iEu = 1:length(eu)
        ...
        etaTemp = eu(iEu).getETA('count', 'stimtwocolor', [-0.5, 0.5], normalize=[-0.5, -0.1], resolution=0.025, alignTo='start', ...
